...
[crate-ci/typos](https://github.com/crate-ci/typos), used as a Cargo
dependency.
...
http://wordlist.aspell.net/, Copyright 2000-2026 by Kevin Atkinson.
Permission to use, copy, modify, distribute and sell these word lists and
their derivatives is granted without fee, subject to retention of the
original copyright notices. The full SCOWL copyright file accompanies the
registry artifact.
...
`frequency_dictionary_en_82_765.txt` (MIT License, Copyright Wolf Garbe),
which was in turn created by intersecting Google Books Ngram data
(CC BY 3.0, https://books.google.com/ngrams/) with SCOWL.

## Sudachi synonym dictionary (registry artifact `ja-variants`, not bundled)

Japanese loanword variant pairs distributed through the registry are
extracted from the [SudachiDict](https://github.com/WorksApplications/SudachiDict)
